...
2. 盗用他人账号
3. 轰炸BBot
4. 使用机器人在==?xq102210==公屏上发送大量签到（建议私信或前往==?bot==）
...
xc = XChat.XChat("BlazeRobot", "testbbot", "BBot", '080314')
xc.message_function += [
